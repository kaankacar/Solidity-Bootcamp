...
contract Fourth_Homework {
    ...
    function calculateCurrentState() private view returns (bool) {
        ...
        uint256 majority = totalVotes / 2; // This defines the majority threshold

        // A proposal is considered successful if it has more than half of the total votes in approval
        if (proposal.approve > majority) {
            return true;
        } else {
            return false;
        }
